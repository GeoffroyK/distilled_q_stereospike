...
from .simple_cnn import SimpleCNN, QuantSimpleCNN



__all__ = ['resnet20_quant', 'resnet20_fp', 'resnet32_quant', 'resnet32_fp', 'resnet18_fp', 'resnet18_quant', 'simple_cnn_fp', 'simple_cnn_quant']
...
def simple_cnn_fp(args):
    return SimpleCNN()

def simple_cnn_quant(args):
    return QuantSimpleCNN(args)
